...
def attack(char_name: str, char_class: Optional[str]) -> str:
    """Рандомно рассчитывает урон в зависимости от типа персонажа."""
...
def defence(char_name: str, char_class: Optional[str]) -> str:
    """Рандомно рассчитывает защиту в зависимости от типа персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: Optional[str]) -> str:
    """Рандомно рассчитывает умение в зависимости от типа персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: Optional[str]) -> str:
    """Начинает разные тренировки в зависимости от ввода пользователя."""
    if char_class == 'warrior':
...
def choice_char_class() -> Optional[str]:
    """Выбирает тип персонажа в зависимости от ввода пользователя."""
